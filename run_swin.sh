...
python build_image_db.py --dpath=cifar100 --img_size=224 --save_path=cifar100/para/model.ep12 --batch_size=256 --input=train_image_set.npy --output=database.npy --arch=resnet101
python build_image_db.py --dpath=cifar100 --img_size=224 --save_path=cifar100/para/model.ep12 --batch_size=256 --input=test_image_set.npy --output=tdatabase.npy --arch=resnet101
# Swin + ATT 224 224 
