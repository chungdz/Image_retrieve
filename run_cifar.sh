...
python build_image_db.py --dpath=cifar100 --img_size=224 --save_path=cifar100/para/model.ep7 --batch_size=256 --input=train_image_set.npy --output=database.npy --arch=swingl
python build_image_db.py --dpath=cifar100 --img_size=224 --save_path=cifar100/para/model.ep7 --batch_size=256 --input=test_image_set.npy --output=tdatabase.npy --arch=swingl
# DeiT + CLS 224 224
