...
python process_data.mips.py --dpath=ir --batch_size=1024 --k=20
python process_data.mips.py --dpath=ir --batch_size=1024 --k=20 --isValid=1 --to_test=valid_for_test.npy --test_matrix=database.npy
# Or LOPQ
